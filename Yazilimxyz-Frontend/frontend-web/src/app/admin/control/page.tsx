...
// ControlLayout ve AdminSidebar tarafından otomatik olarak sarmalanacaktır.
          ...
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              ...
              <tr>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Mehmet Kaya</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                  <span className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">Tamamlandı</span>
                </td>
