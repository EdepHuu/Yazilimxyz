      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Link
            ...
            className="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-4 px-6 rounded-lg text-center transition-colors duration-200"
          >
            Ürünleri Yönet
          </Link>
          <Link
            href="/admin/control/orders"
            className="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-4 px-6 rounded-lg text-center transition-colors duration-200"
          >
