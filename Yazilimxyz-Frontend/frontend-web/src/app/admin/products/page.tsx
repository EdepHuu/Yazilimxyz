...
// ProductsPage bileşeni, ürün yönetimini temsil eder.
// API'den veri alınana kadar statik bir tablo ve yer tutucular içerir.
const ProductsPage = () => {
  // Mock (sahte) ürün verileri. Gerçek veriler API'den gelecek.
